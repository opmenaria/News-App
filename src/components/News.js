...
const News = (props) => {
    ...
    const updateNews = async () => {
        props.setProgress(10) //for loading top bar
        ...
        setLoading(false) //top loading bar
    ...
    return (
        <>
            <h1 className='text-center' style={{ margin: "10px 0px", marginTop: '100px' }}>NewsMan-Top {capitalizeFirstLetter(props.category)} Headlines</h1>
            {loading && <Spinner />}
            <InfiniteScroll
